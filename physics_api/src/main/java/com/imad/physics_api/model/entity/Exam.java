...
@Table(name = "exams", indexes = {
        ...
        @Index(name = "idx_exam_level", columnList = "academic_level"),
...
public class Exam extends BaseEntity {
    ...
    private List<ExamAccess> examAccesses = new ArrayList<>();

    // Constructors
    public Exam() {}

    public Exam(String title, String description, ExamType examType,
                AcademicLevel academicLevel, Branch branch, String filePath,
    ...
    public boolean isPublished() {
        return status == ExamStatus.ACTIVE && publishedAt != null;
    }
    ...
    public List<ExamAccess> getExamAccesses() { return examAccesses; }
    public void setExamAccesses(List<ExamAccess> examAccesses) { this.examAccesses = examAccesses; }
}